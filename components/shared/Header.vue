<template>
  <header class="bg-transparent absolute w-full">
    <div class="flex items-center justify-between px-6 pt-10">
      <NuxtLink :to="{ path: '/', hash: '#anchor' }">
        <img
          class="w-28"
          src="../../assets/shared/desktop/logo-grey.svg"
          alt="PayApi logo"
        />
      </NuxtLink>
